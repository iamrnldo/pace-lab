  ...
  return (
    <>
          ...
          {result ? (
            ...
            <div className="card-retro flex min-h-[320px] flex-col items-center justify-center p-6 text-center">
              ...
              <p className="mt-2 font-sport text-sm text-retro-white/20">
                VCR result, training zones, and summary appear here.
              </p>
            </div>
          )}
        </div>
      ...
      <Modal
        ...
        title="VCR DETAIL CALCULATION"
      >
        {result && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
              <div className="card-retro p-5">
                <p className="font-mono text-[11px] uppercase tracking-widest text-retro-white/40">
                  VCR
                </p>
                <p className="mt-3 font-retro text-5xl text-retro-green tabular-nums">
                  {result.vcrMs.toFixed(2)}
                </p>
                <p className="mt-2 font-mono text-xs text-retro-white/35">
                  m/s · {result.vcrKmh.toFixed(2)} km/h
                </p>
              </div>
              <div className="card-retro p-5 lg:col-span-2">
                <p className="mb-3 font-mono text-[11px] uppercase tracking-widest text-retro-white/40">
                  Summary
                </p>
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-2">
                  <div className="border border-retro-gray-light/25 bg-retro-black/10 p-3">
                    <p className="font-mono text-[10px] uppercase tracking-widest text-retro-white/35">
                      Duration
                    </p>
                    <p className="mt-2 font-retro text-2xl text-retro-white tabular-nums">
                      {`${result.testMinutes} min`}
                    </p>
                  </div>
                  ...
                  <div className="border border-retro-gray-light/25 bg-retro-black/10 p-3">
                    ...
                    <p className="mt-2 font-retro text-2xl text-retro-white tabular-nums">
                      {`${result.distanceMeters.toLocaleString()} m`}
                    </p>
                  </div>

                  <div className="border border-retro-gray-light/25 bg-retro-black/10 p-3 col-span-2">
                    <p className="font-mono text-[10px] uppercase tracking-widest text-retro-white/35">
                      Base Pace
                    </p>
                    <p className="mt-2 font-retro text-2xl text-retro-white tabular-nums">
                      {`${result.basePacePerKm}/km`}
                    </p>
                  </div>
                </div>
              </div>
